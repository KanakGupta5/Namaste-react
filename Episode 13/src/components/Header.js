        ...
        <div className="flex justify-between bg-amber-100 items-center">
            ...
            <div className="flex">
                <ul className="flex">
                    ...
                    <li className="p-4 hover:bg-amber-200"><Link to='/pokemon'>Pokemon</Link></li>
                    <li className="p-4 hover:bg-amber-200"><Link to='/cart'>Cart {cartItems.length > 0 ? cartItems.length : ''}</Link></li>
                </ul>
