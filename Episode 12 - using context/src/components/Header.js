            ...
            <div className="flex">
                <ul className="flex">
                    ...
                    <div className="relative">
                        <li onClick={() => setShowCart(!showCart)} className="p-4 hover:bg-amber-200">Cart {cartItems.length > 0 ? <span>[{cartItems.length}]</span> : ""}</li>
                        {showCart && cartItems.length > 0 && <CartList />}
                    </div>
                </ul>
